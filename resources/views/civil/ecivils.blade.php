                                   ...
                                   <!--   Se comprueba el peso deseado (BUDGET/AREAS) -->
                                     ...
                                     <!--   FIN DE LA COMPROBACIÓN (BUDGET/AREAS) -->
                                                ...
                                                <?php // LEYENDA DE STEPS
                                                            ...
                                                            $pcivils = DB::select("SELECT * FROM pcivils"); 

                                                            echo "<table border='1'><tr>";
                                                            foreach ($pcivils as $pcivilss) {

                                                                echo "<td style='font-size: 14px;color:red;font-weight:bold;text-align:center'>&nbsp;".$pcivilss->name."&nbsp;</td>";      
                                                            }
                                                            echo "</tr><tr>";
                                                            foreach ($pcivils as $pcivilss) {

                                                                echo "<td style='font-size: 14px;color:red;text-align:center'>&nbsp;".$pcivilss->percentage."%&nbsp;</td>";      
                                                            }
                                                            echo "</tr></table>";
