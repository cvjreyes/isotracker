                                   ...
                                   <!--   Se comprueba el peso deseado (BUDGET/AREAS) -->
                                     ...
                                     <!--   FIN DE LA COMPROBACIÓN (BUDGET/AREAS) -->
                                                ...
                                                <?php // LEYENDA DE STEPS
                                                            ...
                                                            $pinsts = DB::select("SELECT * FROM pinsts"); 

                                                            echo "<table border='1'><tr>";
                                                            foreach ($pinsts as $pinstss) {

                                                                echo "<td style='font-size: 14px;color:red;font-weight:bold;text-align:center'>&nbsp;".$pinstss->name."&nbsp;</td>";      
                                                            }
                                                            echo "</tr><tr>";
                                                            foreach ($pinsts as $pinstss) {

                                                                echo "<td style='font-size: 14px;color:red;text-align:center'>&nbsp;".$pinstss->percentage."%&nbsp;</td>";      
                                                            }
                                                            echo "</tr></table>";
