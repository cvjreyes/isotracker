    ...
    <tr>
      ...
      <td>
           ...
           <?php if ($requested[0]->requested!=1 AND $requested[0]->requestedlead!=1){ ?> <!-- Si no tiene solicitud desde diseño puede enviar a siguiente etapa -->
            ...
            <?php if (file_exists($pdfcl) AND file_exists($zip)/*AND file_exists($bfile) AND file_exists($dxf) AND file_exists($cii)*/) { ?>
            ...
            <?php }else{ ?>
              ...
              <a class="comments-design-modal btn btn-xs btn-info" data-filename ="<?php echo $filename[$i]; ?>" data-toggle="modal" data-target=""><b>MISSING DOCUMENTS!</b></a>
