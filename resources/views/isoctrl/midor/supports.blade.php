    ...
    <tr>
      ...
      <td>
           ...
           <?php if ($requested[0]->requested==0 AND $requested[0]->requestedlead==0 AND $requested[0]->deleted!=1 AND $requested[0]->verifysupports==0){ ?> <!-- Si no tiene solicitud desde diseño o no esta borrada puede enviar a siguiente etapa -->
            ...
            <!--   <a class="comments-supports-modal btn btn-xs btn-success" data-filename ="<?php echo $filename[$i]; ?>" data-toggle="modal" data-target="#commentsfromsupportsModal">Spool</a> -->
      ...
      <!-- <button class="btn btn-sm btn-success" name="destination" value="materials">Spool</button> -->
