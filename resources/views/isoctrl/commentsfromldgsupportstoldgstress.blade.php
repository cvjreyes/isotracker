...
@else
    ...
    <div class="modal fade" id="commentsfromldgsupportstoldgstressModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="commentsfromldgsupportstoldgstressModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/sendtoldgstressfromldgsupports') }}">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> {!! Form::text('verifysupports', null, array('placeholder' => 'verifysupports','class' => 'verifysupports','readonly')) !!}
                                    </td>
                        ...
                        <input type="submit" class="btn btn-lg btn-primary" style="padding: 8px 16px;font-size: 12px;" value="LDG Stress">
