...
@else
    ...
    <div class="modal fade" id="rejectfromldgdesignModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="rejectfromldgdesignModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/rejectfromldgdesign') }}">
