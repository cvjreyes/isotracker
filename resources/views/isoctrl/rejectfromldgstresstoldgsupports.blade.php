...
@else
    ...
    <div class="modal fade" id="rejectfromldgstresstoldgsupportsModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="rejectfromldgstresstoldgsupportsModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/rejectfromldgstresstoldgsupports') }}">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> {!! Form::text('verifystress', null, array('placeholder' => 'verifystress','class' => 'verifystress','readonly')) !!}
                                    </td>
                        ...
                        <input type="submit" class="btn btn-lg btn-danger" style="padding: 8px 16px;font-size: 12px;" value="LDG Supports">
