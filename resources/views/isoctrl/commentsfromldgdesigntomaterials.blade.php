...
@else
    ...
    <div class="modal fade" id="commentsfromldgdesigntomaterialsModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="commentsfromldgdesigntomaterialsModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/sendtomaterialsfromldgdesign') }}">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> {!! Form::text('verifybydesign', null, array('placeholder' => 'verifybydesign','class' => 'verifybydesign','readonly')) !!}
                                    </td>
                        ...
                        <input type="submit" class="btn btn-lg btn-warning" style="padding: 8px 16px;font-size: 12px;" value="Materials">
