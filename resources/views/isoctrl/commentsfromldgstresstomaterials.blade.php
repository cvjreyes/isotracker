...
@else
    ...
    <div class="modal fade" id="commentsfromldgstresstomaterialsModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="commentsfromldgstresstomaterialsModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/sendtomaterialsfromldgstress') }}">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> {!! Form::text('verifybystress', null, array('placeholder' => 'verifybydesign','class' => 'verifybydesign','readonly')) !!}
                                    </td>
