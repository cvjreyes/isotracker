...
@else
    ...
    <div class="modal fade" id="commentsfromsupportstostressModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="commentsfromsupportstostressModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/sendtostressfromsupports') }}">
                    ...
                    <table class="table table-striped">
                        ...
                        <input type="submit" class="btn btn-lg btn-primary" style="padding: 8px 16px;font-size: 12px;" value="Stress">
