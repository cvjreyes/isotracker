...
@else
    ...
    <div class="modal fade" id="commentsfromldgsupportstomaterialsModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="commentsfromldgsupportstomaterialsModalLabel">
   <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/sendtomaterialsfromldgsupports') }}">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> {!! Form::text('verifybysupports', null, array('placeholder' => 'verifybysupports','class' => 'verifybysupports','readonly')) !!}
                                    </td>
                        ...
                        <input type="submit" class="btn btn-lg btn-success" style="padding: 8px 16px;font-size: 12px;" value="Materials">
